...
import { useExplainApi, useUnitTestApi } from "@/hooks/openai-api";
...
const UnitTest: FC<UnitTestProps> = (props) => {
  ...
  // call api
  const { response, loading, error, valid, handleSubmit } = useUnitTestApi();
  const onClick = async () => {
